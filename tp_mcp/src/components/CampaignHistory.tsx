      ...
      <div className="space-y-2">
        {campaigns.map((campaign) => {
          ...
          return (
            <div
              key={campaign.id}
              className="rounded-2xl border border-red-200/20 bg-zinc-900/40"
            >
              <button
                type="button"
                onClick={toggle}
                className="flex w-full items-center justify-between gap-4 px-4 py-3 text-left text-sm text-white"
              >
                <div>
              ...
              {isOpen && (
                <div className="space-y-3 border-t border-red-200/10 px-4 py-4 text-sm text-zinc-200">
                  <p className="text-xs text-zinc-400">
